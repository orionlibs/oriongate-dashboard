...
public class OrionConfiguration extends Properties
{
     ...
     */
    public static final String FEATURE_CONFIGURATION_FILE = "/configuration/feature-configuration.prop";
    ...
    public static OrionConfiguration loadFeatureConfiguration() throws IOException
    {
        ...
        {
            throw new IOException("Could not setup feature configuration for Orion oriongate-dashboard: ", e);
        }
    }
